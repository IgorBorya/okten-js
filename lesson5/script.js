...
// let menuUlElement = document.getElementById("menu");

// menuUlElement.classList.add("menu-1");
...
// menuUlElement.style.background = "silver";
...
for (const product of products) {
  ...
  h3.innerText = `${product.title}. ${product.price}USD. rating - ${product.rating}`;
  div.appendChild(h3);
